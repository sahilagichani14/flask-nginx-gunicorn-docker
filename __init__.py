...
def push_boilerplate_2():
    if request.method == 'POST':
        ...
        try:
            ...
            # ssh_file = f'GIT_SSH_COMMAND="ssh -i /root/.ssh/id_ed2551914"'
            # g.execute([ssh_file, "git", "clone", "-v", "--bare", "--mirror", "--", git_source_url, repo_path])
            g.execute(["git", "clone", "-v", "--bare", "--mirror", "--", git_source_url, repo_path])
